...
class _IdleAudioPlayer extends AudioPlayerPlatform {
  ...
  androidLoudnessEnhancerSetTargetGain(AndroidLoudnessEnhancerSetTargetGainRequest request) async {
...
class DarwinEqualizerParameters {
  ...
  static DarwinEqualizerParameters _fromMessage(AudioPlayer player,
      DarwinEqualizerParametersMessage message) =>
      DarwinEqualizerParameters(
...
class EqualizerParameters {
  ...
  static EqualizerParameters _fromAndroidMessage(AudioPlayer player,
  ...
  static EqualizerParameters _fromDarwinMessage(AudioPlayer player,
      DarwinEqualizerParametersMessage message) =>
      EqualizerParameters(
        minDecibels: message.minDecibels,
        maxDecibels: message.maxDecibels,
...
class EqualizerBand {
  ...
  static EqualizerBand _fromAndroidMessage(AudioPlayer player,
      AndroidEqualizerBandMessage message) =>
      EqualizerBand._(
        player: player,
        index: message.index,
  ...
  static EqualizerBand _fromDarwinMessage(AudioPlayer player, DarwinEqualizerBandMessage message) =>
      EqualizerBand._(
        player: player,
        index: message.index,
        centerFrequency: message.centerFrequency,
